...
- [X] **Function Modularization (10 points):** Code should be organized into small, clearly named functions with specific purposes. Each function should not exceed 80 lines, reflecting strong typing and avoiding the use of magic numbers or strings.
